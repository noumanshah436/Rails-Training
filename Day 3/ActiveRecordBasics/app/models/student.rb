...
class Student < ApplicationRecord
  ...
  # validate :attachment_content_type    # copied from mrsool
  ...
  #   ICON_CONTENT_TYPE_REGEXP = %r{\Aimage/.*\Z}
  #   return unless icon_ar.attached?
  #   unless ICON_CONTENT_TYPE_REGEXP.match(icon_ar.content_type)
  #     errors.add(
  #       :icon_ar,
  #       I18n.t("validation_messages.incorrect_attachment_content_type")
  #     )
  #   end
  # end
